...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { gene: @variant.gene, refseq: @variant.refseq, url: @variant.url, variant: @variant.variant }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { gene: @variant.gene, refseq: @variant.refseq, url: @variant.url, variant: @variant.variant }
    assert_redirected_to variant_path(assigns(:variant))
  end
