...
class SeedsControllerTest < ActionController::TestCase
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post :create, seed: { help: @seed.help, identifier: @seed.identifier, memmory: @seed.memmory, payload: @seed.payload, publisher: @seed.publisher, title: @seed.title }
    end
  ...
  test "should update seed" do
    patch :update, id: @seed, seed: { help: @seed.help, identifier: @seed.identifier, memmory: @seed.memmory, payload: @seed.payload, publisher: @seed.publisher, title: @seed.title }
    assert_redirected_to seed_path(assigns(:seed))
  end
